...
This is the first supported public Maven Central release. The earlier 5.1.0 build was an unpublished development
preview under `com.lozaine.resourceworldresetter.api`; developers must compile against 5.1.2 and use
the `io.github.tamawish.rwr.api` packages shown in the README and Javadocs.

## 5.1.1 - Withdrawn

Maven Central 5.1.1 was published from an obsolete build containing the
`com.lozaine.resourceworldresetter.api` Java package. It must not be used by current RWR integrations.
